// DPNS data contract ID for testnet
// Find the current value at: https://docs.dash.org/projects/platform/en/stable/docs/reference/data-contracts.html
export const DPNS_CONTRACT_ID = 'GWRSAVFMjXx8HpQFaNJMqBV7MBgMK4br5UESsB4S31Ec';

// Testnet identity and name used across tutorial and query tests
export const IDENTITY_ID = 'GgZekwh38XcWQTyWWWvmw6CEYFnLU7yiZFPWZEjqKHit';
...
export const HISTORY_CONTRACT_ID = 'BJV33YPMDfbA2Cxq3hWuTPQjUQCXEXGyq8bzz1YC9C44';
